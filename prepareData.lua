...
local trainobjcatY = npy.loadnpy('splits/train_objcat_y.npy')
local valobjcatY = npy.loadnpy('splits/val_objcat_y.npy')
...
torch.save('trainobjcat.t7', { x = trainX, y = trainobjcatY })
...
torch.save('valobjcat.t7', { x = valX, y = valobjcatY })
